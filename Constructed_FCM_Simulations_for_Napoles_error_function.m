...
filepath_for_training_X = append("G:\.shortcut-targets-by-id\1-wapAl6N5YrCs68c4NiFKyvybXTXmdgZ\Ph_D_Tyrovolas\Our Papers\3rd_Paper-Proposal\Testbed Codes\AI4I_Case_Study\k-fold cross validation datasets\",num2str(fold),"\Test Dataset","\Scaled_X_test_iter_",num2str(fold),".csv");
filepath_for_training_y = append("G:\.shortcut-targets-by-id\1-wapAl6N5YrCs68c4NiFKyvybXTXmdgZ\Ph_D_Tyrovolas\Our Papers\3rd_Paper-Proposal\Testbed Codes\AI4I_Case_Study\k-fold cross validation datasets\",num2str(fold),"\Test Dataset","\y_test_iter_",num2str(fold),".csv");
...
if contains(filepath_for_training_X,'Training Dataset')==true
    filepath_for_FCM_ouput_concept_values = append("G:\.shortcut-targets-by-id\1-wapAl6N5YrCs68c4NiFKyvybXTXmdgZ\Ph_D_Tyrovolas\Our Papers\3rd_Paper-Proposal\Testbed Codes\AI4I_Case_Study\k-fold cross validation datasets\",num2str(fold),"\Training Dataset","\y_train_pred_fcm.csv");
    writematrix(Outputs,filepath_for_FCM_ouput_concept_values,'Delimiter',',')
    
    filepath_for_FCM_predicted_classes = append("G:\.shortcut-targets-by-id\1-wapAl6N5YrCs68c4NiFKyvybXTXmdgZ\Ph_D_Tyrovolas\Our Papers\3rd_Paper-Proposal\Testbed Codes\AI4I_Case_Study\k-fold cross validation datasets\",num2str(fold),"\Training Dataset","\fcm_pred_class_train.csv");
...
if contains(filepath_for_training_X,'Test Dataset')==true
    filepath_for_FCM_ouput_concept_values = append("G:\.shortcut-targets-by-id\1-wapAl6N5YrCs68c4NiFKyvybXTXmdgZ\Ph_D_Tyrovolas\Our Papers\3rd_Paper-Proposal\Testbed Codes\AI4I_Case_Study\k-fold cross validation datasets\",num2str(fold),"\Test Dataset","\y_test_pred_fcm.csv");
    writematrix(Outputs,filepath_for_FCM_ouput_concept_values,'Delimiter',',')
    
    filepath_for_FCM_predicted_classes = append("G:\.shortcut-targets-by-id\1-wapAl6N5YrCs68c4NiFKyvybXTXmdgZ\Ph_D_Tyrovolas\Our Papers\3rd_Paper-Proposal\Testbed Codes\AI4I_Case_Study\k-fold cross validation datasets\",num2str(fold),"\Test Dataset","\fcm_pred_class_test.csv");
    writematrix(Predicted_classes,filepath_for_FCM_predicted_classes,'Delimiter',',')
