...
CostFunction = @(x) Napoles_improved_error_function(x); %cost function
...
filepath_for_best_solution = append("G:\.shortcut-targets-by-id\1-wapAl6N5YrCs68c4NiFKyvybXTXmdgZ\Ph_D_Tyrovolas\Our Papers\3rd_Paper-Proposal\Testbed Codes\AI4I_Case_Study\near_opt_sol_for_folds\",num2str(fold),"\best_solution_with_napoles_error_function_fold_",num2str(fold),".csv");
