...
filepath_for_opt_solution = append("..\experimental_setup\CCFCM\Corr_Coef_FCM_learning\optimal_phi_corr_FCM\",num2str(fold),"\corr_coeff_FCM_best_phi_fold_",num2str(fold),".csv");
