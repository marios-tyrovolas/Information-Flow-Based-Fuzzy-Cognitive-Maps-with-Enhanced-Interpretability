...
%{
true_positive_observation_I_want_to_see = 169;
figure
...
if true_positive_observations_with_failure_modes(true_positive_observation_I_want_to_see,8)==1
    annotation('textbox', [0.75, 0.1, 0.1, 0.1], 'String', "TWF")    
elseif true_positive_observations_with_failure_modes(true_positive_observation_I_want_to_see,9)==1
        annotation('textbox', [0.75, 0.1, 0.1, 0.1], 'String', "HDF")
elseif true_positive_observations_with_failure_modes(true_positive_observation_I_want_to_see,10)==1
    annotation('textbox', [0.75, 0.1, 0.1, 0.1], 'String', "PWF")
elseif true_positive_observations_with_failure_modes(true_positive_observation_I_want_to_see,11)==1
